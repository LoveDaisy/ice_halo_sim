...
**案例覆盖（2026-07-07 逐条压测,全部可表达)**:单 component ✅ / UI filter=一色(多 summand OR-union)✅ / 同晶体多 filter 各挂色 + **重叠**(z-order)✅ / 跨层 **AND** ✅ / **none-filter** ✅ / 可见性 ✅ / z-order=entry 列表序 ✅。唯一不覆盖 = 通用布尔 NOT/嵌套(刻意延后,可演进)。
...
## 5. 决策台账（owner 已同意；2026-07-05 深化 / 2026-07-06 phase-3 产品模型 / 2026-07-07 引擎定案）
