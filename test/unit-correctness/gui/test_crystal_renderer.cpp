// The crystal edit-modal's 3D mesh view: where CrystalRenderer::ComputeMvp puts a mesh vertex on
// screen. This is a different preview from src/gui/preview_renderer.hpp's sky-dome projection
// (called from app.cpp / app_panels.cpp) — this one is the modal's own camera, called from
// edit_modals.cpp, and it is not reachable through the sky-dome's projection helpers at all.
//
// It guards:
