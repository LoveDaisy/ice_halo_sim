...
// kSimulating" dead-state bug — see doc/gui-preview-lifecycle-architecture.md §2/§6.
// Pins blueprint invariants I1 (epoch-keyed truth), I2
...
//
// Cases here all need a live frame (a real DoRun driven by ctx->Yield(), or real UI clicks):
//  1. gui_lifecycle/gpu_run_reaches_done — INTEGRATION e2e through the real DoRun→completion flow.
//  2. gui_lifecycle/optimistic_async_stop — INTEGRATION of the async Stop (blueprint §5/§8):
...
//  3. gui_lifecycle/run_completed_latch_survives_invalid_snapshot
//  4. gui_lifecycle/display_edits_do_not_disturb_done
//  5. gui_lifecycle/display_edits_via_real_ui_clicks_do_not_disturb_done
//
// The seven frame-independent siblings moved to test/unit-correctness/gui/test_lifecycle.cpp.
